 ...
 * @param alarm One of the two alarms, RTCC_ZERO or RTCC_ONE.
 * @return none
 */
 ...
 * @param alarm One of the two alarms,either alarm RTCC_ZERO or RTCC_ONE.
 * @return none
 */
 ...
 * @param alarm Select either alarm RTCC_ZERO or RTCC_ONE
 * @return none
 */
...
{
    I2C_WriteByteRegister(MCP79410_ADDRESS,rtcc_reg,time_var);
}  
...
{
    return I2C_ReadByteRegister(MCP79410_ADDRESS,rtcc_reg);    	
}
